...
function SurfaceExploration() {
    return (
        <div className="flex w-full max-w-[848px] rounded mx-auto items-center gap-8 p-6 bg-white text-white">
            <div className="w-[40%]">
                <RadarScanner />
            </div>
            <div className="flex flex-col gap-4 w-[60%]">
                ...
                <p className="text-[16.5px] text-black leading-relaxed">
                ...
                <button className="self-start bg-gray-700 hover:bg-gray-500 transition px-6 py-3 rounded text-[16.5px] font-medium">
